...
export async function buildSessionMetadata({
  ...
  role,
  source,
  includeFormVersion = true,
  logger,
}) {
  let formVersion = null;
  let versionError = null;

  if (includeFormVersion && tenantClient) {
  ...
  if (includeFormVersion && formVersion !== null && formVersion !== undefined) {
  ...
  if (includeFormVersion && versionError && logger?.error) {
