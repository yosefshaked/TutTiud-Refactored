...
- **Instructor placeholders** – the Instructor Directory in Settings lets admins create real instructor accounts without sending email ("Create as Placeholder"), flags them as not activated, and offers a manual activation email action that uses the password reset flow.
