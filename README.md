...
- **Student Intake Card** (`src/features/students/components/StudentIntakeCard.jsx`) shows parsed intake key/value pairs on the student profile and renders the stored HTML summary on demand.
