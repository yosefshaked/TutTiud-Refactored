...
export default function ChangelogModal({ open, onClose }) {
  ...
  const [expandedVersions, setExpandedVersions] = useState({ '1.10.0': true });
    ...
    >
      ...
      >
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: 0, color: '#334155', fontSize: 15, lineHeight: 1.7 }}>
          ...
          {/* 1.10.0 - Scroll Position & Form Improvements */}
          <li dir="rtl" style={{ marginBottom: 16, textAlign: 'right' }}>
            <article style={{ display: 'flex', flexDirection: 'column' }}>
              <header
                onClick={() => toggleVersion('1.10.0')}
                style={{
                  cursor: 'pointer',
                  padding: '12px 16px',
                  borderRadius: '8px',
                  background: expandedVersions['1.10.0'] ? '#f8fafc' : 'transparent',
                  border: '1px solid #e2e8f0',
                  transition: 'all 0.2s ease',
                  marginBottom: expandedVersions['1.10.0'] ? '16px' : 0
                }}
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <time dateTime="2026-02-22" style={{ color: '#64748b', fontSize: '14px' }}>
                      22 בפברואר 2026
                    </time>
                  </div>
                  <span style={{
                    ...
                    transform: expandedVersions['1.10.0'] ? 'rotate(180deg)' : 'rotate(0deg)',
                ...
                <h3 style={{
                  ...
                  ✨ שיפורים בניווט וטפסים
                </h3>
              </header>

              {expandedVersions['1.10.0'] && (
              <section style={{ paddingRight: '16px' }}>
                <ul style={{
                  ...
                  <li>🔄 שמירה וחזרה לעמדת גלילה - כאשר חוזרים מפרופיל תלמיד לרשימה, העמדת הגלילה נשמרת בדיוק כפי שהייתה.</li>
                  <li>📋 ארגון טוב יותר של טפסים - שדה בחירת המדריך הועבר להוביע אחרי בחירת השירותים, עבור זרימת משתמש טוב יותר.</li>
                </ul>
              </section>
              )}
            </article>
          ...
          <li dir="rtl" style={{ marginBottom: 16, textAlign: 'right' }}>
            <article style={{ display: 'flex', flexDirection: 'column' }}>
              <header
                onClick={() => toggleVersion('1.9.2')}
                style={{
                  cursor: 'pointer',
                  padding: '12px 16px',
                  borderRadius: '8px',
                  background: expandedVersions['1.9.2'] ? '#f8fafc' : 'transparent',
                  border: '1px solid #e2e8f0',
                  transition: 'all 0.2s ease',
                  marginBottom: expandedVersions['1.9.2'] ? '16px' : 0
                }}
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <time dateTime="2026-01-29" style={{ color: '#64748b', fontSize: '14px' }}>
                      29 בינואר 2026
                    </time>
                  </div>
                  <span style={{
                    ...
                    color: '#64748b',
                    transition: 'transform 0.2s ease',
                    transform: expandedVersions['1.9.2'] ? 'rotate(180deg)' : 'rotate(0deg)',
                    display: 'inline-block'
                  }}>
                    ▼
                  </span>
              ...
              <section style={{ paddingRight: '16px' }}>
                <ul style={{
                  ...
                  <li>תוקנה תקלה בעריכת תלמידים מרשימת התלמידים (רלוונטי למנהלים).</li>
                </ul>
              </section>
              )}
            </article>
          ...
          {/* 1.9.1 - Intake Refinements */}
          <li dir="rtl" style={{ marginBottom: 16, textAlign: 'right' }}>
            <article style={{ display: 'flex', flexDirection: 'column' }}>
              <header
                onClick={() => toggleVersion('1.9.1')}
                style={{
                  cursor: 'pointer',
                  padding: '12px 16px',
                  borderRadius: '8px',
                  background: expandedVersions['1.9.1'] ? '#f8fafc' : 'transparent',
                  border: '1px solid #e2e8f0',
                  transition: 'all 0.2s ease',
                  marginBottom: expandedVersions['1.9.1'] ? '16px' : 0
                }}
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <span style={{
                    ...
                    color: '#64748b',
                    transition: 'transform 0.2s ease',
                    transform: expandedVersions['1.9.1'] ? 'rotate(180deg)' : 'rotate(0deg)',
                    display: 'inline-block'
                  }}>
                    ▼
                  </span>
