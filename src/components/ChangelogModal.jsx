              ...
              <section style={{ paddingRight: '16px' }}>
                ...
                <ul style={{
                  ...
                  <li style={{ marginBottom: '6px' }}>
                    <strong>ייצוא ויבוא נתוני תלמידים:</strong> ייצוא לקובץ Excel של כל התלמידים, תלמידים בעייתיים בלבד (חסרי ת"ז, מדריך לא פעיל, התנגשויות בלו"ז), או לפי סינון. ניתן לערוך בקובץ ולייבא בחזרה לעדכון מהיר של מספר תלמידים בבת אחת
                  </li>
                  <li style={{ marginBottom: '6px' }}>
                    <strong>מספר זהות:</strong> שדה חובה וייחודי לכל תלמיד למניעת כפילויות והבחנה בין תלמידים עם שמות דומים
                  </li>
                  <li style={{ marginBottom: '6px' }}>
                    <strong>התראה על שמות דומים:</strong> בעת יצירה או עריכה של תלמיד, המערכת מציגה תלמידים קיימים עם שמות דומים כדי למנוע כפילויות
                  </li>
                  <li style={{ marginBottom: '6px' }}>
                ...
                <ul style={{
                  ...
                  <li style={{ marginBottom: '6px' }}>
                    <strong>תיעוד מפגש משופר:</strong> לאחר שמירת מפגש, ניתן לבחור את התאריך הבא (אותו התאריך, היום, או תאריך אחר) - מקל על תיעוד רצף מפגשים
                  </li>
                  <li style={{ marginBottom: '6px' }}>
                    <strong>סינון לפי יום:</strong> הוספת אפשרות "הכל" לאיפוס סינון היום
                  </li>
                  <li style={{ marginBottom: '6px' }}>
                ...
                <ul style={{
                  ...
                  <li style={{ marginBottom: '6px' }}>
                    <strong>הגנה על דף מנהל:</strong> משתמשים שאינם מנהלים מנותבים אוטומטית לדף התלמידים שלהם במקום לקבל גישה לדף ניהול התלמידים
                  </li>
                  <li style={{ marginBottom: '6px' }}>
                    <strong>רענון לוח השנה:</strong> לוח החום בדף הראשי מתעדכן אוטומטית לאחר יצירת מפגש חדש
                  </li>
                </ul>
              </section>
              )}
