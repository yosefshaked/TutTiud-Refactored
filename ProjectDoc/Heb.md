...
**גרסה: 1.12.0**
**תאריך עדכון אחרון: 2025-10-23**

## 1. חזון ומטרה

מטרת הפרויקט היא לספק פתרון אפליקטיבי, נוח ויעיל לניהול תשלומי שכר לעובדים, כתחליף לקובץ אקסל שהיה מועד לטעויות.
החל מגרסה 1.12.0 המערכת ממותגת בשם TutTiud תוך החלפת המיתוג ההיסטורי של הפלטפורמה, ללא שינוי בפונקציונליות הקיימת. המערכת מותאמת אישית לצרכים של עסק עם שני סוגי עובדים עיקריים: עובדים שעתיים ומדריכים המקבלים תשלום פר-סשן.
