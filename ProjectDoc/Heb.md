...
- **NewSessionForm.jsx** – טופס בעברית לשאלון המפגש. בוחר תלמיד אוטומטית כאשר נפתח מעמוד הפרטים, מציג ליד כל תלמיד את יום/שעת ברירת המחדל, ממלא מראש את השירות ומאפשר לערוך תשובות לכל שאלה מוגדרת. ערכים ריקים נמחקים מהמטען לפני השליחה.
