...
- **ניתוב וניווט** – `src/main.jsx` מפנה את `/Employees` ל-`/admin/students` וטוען את העמוד החדש. `src/Layout.jsx` מעדכן את ערך התפריט (תווית + URL) כך שיתאים לזרימת התלמידים ומרענן את תיאור הצד ל"ניהול תלמידים והדרכה".

## 10. יסודות מערכת העיצוב (Mobile-First UI Kit)
